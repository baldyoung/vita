...
-- 系统消息表
DROP TABLE IF EXISTS V_SystemMessage;
CREATE TABLE V_SystemMessage (
	id INT UNSIGNED UNIQUE NOT NULL AUTO_INCREMENT COMMENT'主键',
	statusFlag TINYINT DEFAULT 0 COMMENT'状态标识',
	typeFlag TINYINT COMMENT'类型标识',
	senderId VARCHAR(20) NOT NULL COMMENT'发送方编号',
	sendDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT'发送时间',
	messageTitle VARCHAR(20) COMMENT'消息标题',
	messageContent VARCHAR(100) COMMENT'消息内容',
	receptionDate DATETIME COMMENT'接收时间',
