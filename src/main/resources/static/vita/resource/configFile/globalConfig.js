...
function toOrderItemStatusNameStyle(statusId) {
    ...
    switch (statusId) {
        case 0 :
            temp = '<span style="background:#FFCCCC; color:#000000;">待确定</span>';
            break;
        case 1 :
            temp = '<span style="background:#FFFF66; color:#000000;">缺货中</span>';
            break
        case 2 :
            temp = '<span style="background:#99CCFF; color:#000000;">备货中</span>';
            break
        case 3 :
            temp = '<span style="background:#99CC99; color:#000000;">已完成</span>';
            break
        case 4 :
            temp = '<span style="background:#000000; color:#FFFFFF;">已删除</span>';
            break
    }
    html += temp;
    html += "";
